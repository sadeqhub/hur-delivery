...
class DriverWalkthroughScreen extends StatefulWidget {
  ...
  @override
  State<DriverWalkthroughScreen> createState() => _DriverWalkthroughScreenState();
}

class _DriverWalkthroughScreenState extends State<DriverWalkthroughScreen> {
                ...
                child: PageView(
                  ...
                  children: [
                    _WalkthroughPage(
                      ...
                      title: loc.driverWalkthroughTitle1,
                      description: loc.driverWalkthroughDesc1,
                      screenHeight: screenHeight,
                      screenWidth: screenWidth,
                    ),
                    _WalkthroughPage(
                      imagePath: 'assets/images/banner2.png',
                      title: loc.driverWalkthroughTitle2,
                      description: loc.driverWalkthroughDesc2,
                      screenHeight: screenHeight,
                      screenWidth: screenWidth,
                    ),
                    _WalkthroughPage(
                      imagePath: 'assets/images/banner3.png',
                      title: loc.driverWalkthroughTitle3,
                      description: loc.driverWalkthroughDesc3,
                      screenHeight: screenHeight,
                      screenWidth: screenWidth,
                    ),
                  ],
